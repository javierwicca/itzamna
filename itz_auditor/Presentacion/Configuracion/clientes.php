<html>
	<head>
		...
		<script type="text/javascript" src="../../Javascript/Configuracion/clientes.js"></script>
	</head>
										...
										<table class="tabla_login" align="center">
											<tr>
												<td id="tit_tabla" onclick="Effect.toggle('argumentos','slide'); return false;">
													...
													<input name="action" id="action" value="consultarClientes" type="hidden">
													...
													<input name="list_cliente" id="list_cliente" type="hidden">
													ARGUMENTOS
												</td>
											</tr>
											<tr>
														...
														<table cellpadding="2" cellspacing="2">
															<tbody>
																<tr>
																	...
																	<td id="texto_mayus">
																		<span dojoType="dojo.data.ItemFileReadStore" jsId="list_t_nombre_store" url="../../Stores/comboClientes.php" 
