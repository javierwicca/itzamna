<html>
	<head>
		...
		<script type="text/javascript" src="../../Javascript/Configuracion/usuarios.js"></script>
	</head>
										...
										<table class="tabla_login" align="center">
											<tr>
												<td id="tit_tabla" onclick="Effect.toggle('argumentos','slide'); return false;">
													...
													<input name="action" id="action" value="consultarUsuarios" type="hidden">
													...
													<input name="list_usuario" id="list_usuario" type="hidden">
												...
												<td>
													<div id="argumentos" style="display: ;">
														<table cellpadding="2" cellspacing="2">
															<tbody>
																<tr>
																	<td><div class="texto_negrilla">Usuario</div></td>
																	<td id="alineado_der">
																		<input maxlength="15" style="width: 13em;" name="list_t_usuario" 
																		onkeyup="formatNumber(document.f_consulta.list_t_usuario,',','');" 
																		dojoType="dijit.form.ValidationTextBox" promptMessage="Digite la identificaci&oacute;n del usuario."
																		tooltipPosition="above, below">
																	</td>
																	<td><div class="texto_negrilla">Nombre</div></td>
																	<td id="texto_mayus">
																		<span dojoType="dojo.data.ItemFileReadStore" jsId="list_t_nombre_store" url="../../Stores/comboUsuarios.php" 
																		...
																		placeHolder="Seleccione el nombre del usuario" promptMessage="Seleccione el nombre del usuario." required="false" 
																		tooltipPosition="above,below">
																	</td>
																</tr>
																<tr>
