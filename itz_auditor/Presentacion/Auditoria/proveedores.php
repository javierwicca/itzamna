<html>
	<head>
		...
		<script type="text/javascript" src="../../Javascript/Auditoria/proveedores.js"></script>
	</head>
										...
										<table class="tabla_login" align="center">
											<tr>
												<td id="tit_tabla" onclick="Effect.toggle('argumentos','slide'); return false;">
													...
													<input name="action" id="action" value="consultarProveedores" type="hidden">
													...
													<input name="list_proveedor" id="list_proveedor" type="hidden">
													ARGUMENTOS
												</td>
											</tr>
											<tr>
														...
														<table cellpadding="2" cellspacing="2">
															<tbody>
																<tr>
																	...
																	<td id="texto_mayus">
																		<span dojoType="dojo.data.ItemFileReadStore" jsId="list_t_nombre_store" url="../../Stores/comboProveedores.php" 
