<html>
	<head>
		...
		<script type="text/javascript" src="../../Javascript/Auditoria/movimiento.js">
		</script>
	</head>
								...
								<td valign="top">
									<form action="" name="f_consulta" method="post" onsubmit="return consultar();">
										...
										<div style="text-align: left; font-weight: bold; display: none;" id="i_totales">
											<span id="i_activo">Correctos:</span>&nbsp;&nbsp;<span class="texto_rojo" id="i_inactivo">Anulados:</span>
											&nbsp;&nbsp;<span style="color: blue;" id="i_total">TOTAL:</span>
											<br>
											<span id="i_valores"></span>
										</div>
									</form>
								</td>
							</tr>
