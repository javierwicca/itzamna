...
class ClientesEntidad{
	...
	public function setRetefuenteTodos($_retefuenteTodos) {
		$this->retefuenteTodos[$this->idx]= $_retefuenteTodos;
	}
	
	public function getRetefuenteTodos() {
		return $this->retefuenteTodos;
	}
