...
?>
		<page style="font-size: 10pt; font-family:Times;" backtop="12.5mm">
			<page_header>
				...
				<table cellpadding="0" cellspacing="0" style="width: 100%">
					<tr>
						<td style="text-align: center; width: 30%; font-weight: bold; border: solid 1px;">
							C&oacute;digo
						</td>
						<td style="text-align: center; width: 70%; font-weight: bold; border-top: solid 1px; border-right: solid 1px; border-bottom: solid 1px;">
							Nombre
						</td>
					</tr>
				</table>
			...
			<table cellpadding="0" cellspacing="0" style="width: 100%">
				...
				?>
						<tr>
							<td style="text-align: center; width: 30%; border-left: solid 1px; border-right: solid 1px; border-bottom: solid 1px; color: <?php echo $color?>;">
								<?php echo $this->NegocioFacade->reempCaracEspHtml(number_format($columnas[0]))?>
							</td>
							<td style="text-align: left; width: 70%; border-right: solid 1px; border-bottom: solid 1px; color: <?php echo $color?>;">
