<?php
	...
	->setDescription(utf8_encode("Listado de cuentas puc con la siguiente condición: $where."))
	...
	$table->addCell(3000, $styleCell)->addText('Ecuación Patrimonial', 'fBold','pCenter');
