<?php
	...
	->setSubject(utf8_encode("Listado de Usuarios."))
	->setDescription(utf8_encode("Listado de Usuarios con la siguiente condición: $where."))
	->setKeywords(utf8_encode("USUARIOS"));
	...
	$table->addCell(2500,array('valign'=>'center'))->addText("USUARIOS",'fSize10','pCenter');
	...
	// Add cells
	$table->addCell(1500, $styleCell)->addText('Codigo', 'fBold','pCenter');
	$table->addCell(2500, $styleCell)->addText('Nombre', 'fBold','pCenter');
	$table->addCell(1000, $styleCell)->addText('Correo', 'fBold','pCenter');
	$table->addCell(1000, $styleCell)->addText('Perfil', 'fBold','pCenter');
	...
	for ($i=0;$i<count($filas);$i++) {
		...
		$table->addCell(2500, $styleCell)->addText(mb_strtoupper($columnas[6]), $fontStyle,null);
		$table->addCell(1000, $styleCell)->addText(mb_strtoupper($columnas[1]), $fontStyle,null);
		$table->addCell(1000, $styleCell)->addText(mb_strtoupper($columnas[7]), $fontStyle,null);
	}
